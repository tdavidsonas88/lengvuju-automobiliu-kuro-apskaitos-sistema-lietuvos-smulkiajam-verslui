...
<script>
                     ...
                     $(document).ready(function() {
                               ...
                               $.post("getLatestKmEnd", { auto_nr: $('#DistanceAuto').val()},function(data) {
                                $('#DistanceKmBegin').val(data);
                               });
...
//                                
                        ...
                        {
                                $.post("getCarFuelType", { auto_nr: $('#DistanceAuto').val()},function(data) {
                                $('#PurchaseType').val(data);
                               });
                        }
                        
                        function getLatestToLocation(e)
                        {
                                $.post("getLatestToLocation", { auto_nr: $('#DistanceAuto').val()},function(data) {
                                $('#DistanceFromLocation').val(data);
                               });
...
<!--					<ul class="nav">
	...
	<!--<label id="for-is-ajax" class="hidden-tablet" for="is-ajax"><input id="is-ajax" type="checkbox"> Ajax on menu</label>-->
			...
			<div>
				<ul class="breadcrumb">
					<li>
						<a href="#"><?php echo __('btn_new_distance'); ?></a> 
					</li>
				</ul>
			</div>
				...
				<div class="box span4">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i> <?php  echo __('btn_new_distance'); ?></h2>
						<div class="box-icon">
						  ...
						  <fieldset>
                                                      ...
                                                      <div class="control-group form-horizontal">
                                                           ...
                                                           <div class="controls form-horizontal">
                                                               <?php
                                                                    echo $this->Form->input('Distance.auto', array(
                                                      ...
                                                      <div class="control-group form-horizontal">
                                                                        <label class="control-label" for="focusedInput"><?php echo __('project'); ?></label>
                                                           <div class="controls form-horizontal">
                                                               <?php
                                                                    echo $this->Form->input('Distance.project', array(
                                                                         'options' => $list2, 'label' => false,
                                                                    //     'empty' => '(choose one)'
                                                                     ));
                                                                ?>  
                                                      ...
                                                      <div class="control-group form-horizontal">
                                                           <label class="control-label" for="focusedInput"><?php echo __('km_begin'); ?></label>
                                                           <div class="controls form-horizontal">
                                                                <?php  echo $this->Form->input('Distance.km_begin', array('label' => false, 'class' => 'focused') ); ?>
                                                                <?php  echo $this->Form->input('Distance.user_id', array('value' => $user_id, 'label' => false, 'type' => 'hidden')); ?>
                                                           </div>
                                                      </div>
                                                      ...
                                                      <div class="control-group form-horizontal">
                                                           <label class="control-label" for="focusedInput"><?php echo __('km_end'); ?></label>
                                                           <div class="controls form-horizontal">
                                                                <?php  echo $this->Form->input('Distance.km_end', array('label' => false, 'class' => 'focused') ); ?>
                                                           </div>
                                                      </div>
                                                      ...
                                                      <div class="control-group form-horizontal">
                                                           ...
                                                           <div class="controls form-horizontal">
                                                                <?php  echo $this->Form->input('Distance.fuel_left', array('label' => false, 'class' => 'focused') ); ?>
                                                           </div>
                                                      </div>
                                                      
                                                      
                                                       <div class="control-group form-horizontal">
                                                           <label class="control-label" for="focusedInput"><?php echo __('purpose'); ?></label>
                                                           <div class="controls form-horizontal">
                                                                <?php  echo $this->Form->input('Distance.purpose', array('label' => false, 'class' => 'focused', 'type' => 'textarea') ); ?>
                                                           </div>
                                                      </div>
                                                      
                                                      
                                                       <div class="control-group form-horizontal">
                                                           <label class="control-label" for="focusedInput"><?php echo __('km'); ?></label>
                                                           <div class="controls form-horizontal">
                                                                <?php  echo $this->Form->input('Distance.km', array('type' => 'text',
                                                                    'readonly' => 'readonly','label' => false, 'class' => 'focused', ) ); ?>
                                                           </div>
                                                      </div>
