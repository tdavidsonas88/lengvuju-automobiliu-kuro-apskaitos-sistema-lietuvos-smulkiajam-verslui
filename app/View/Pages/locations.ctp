			...
			<div>
			 ...
			 <div class="row-fluid sortable">
					...
					<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i> <?php echo __('locations'); ?></h2>
						<div class="box-icon">
						  ...
						  <tbody>
						  		...
						  		<?php
                                                                         ...
                                                                         foreach( $locations_list as $location_name ) {
                                                                            ...
                                                                            echo "<tr>";
										printf('<td id = %s.Location.name class="center edit">%s</td> ' , $location_name[ 'Location' ][ 'location_id' ], $location_name[ 'Location' ][ 'name' ]);
                                                                               echo '
											<td class="center">
										 ...
										 echo $this->Form->postLink('<i class="icon-trash icon-white"> </i>', 
                                                                                            array('action' => 'delete',$location_name['Location']['location_id'], 'Location'),
...
//                                                                                            array('confirm' => 'Are you sure?', 'class' => 'btn btn-danger', 'escape' => false));	
				...
				<div class="box span4">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i> <?php  echo __('locations'); ?></h2>
						<div class="box-icon">
<!--							<a href="#" class="btn btn-setting btn-round"><i class="icon-cog"></i></a>
-->							<a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
							<a href="#" class="btn btn-close btn-round"><i class="icon-remove"></i></a>
					...
					<div class="box-content">
						  ...
						  <fieldset>
                                                      ...
                                                      <div class="control-group-location form-horizontal">
                                                                        <label class="control-label" for="focusedInput"><?php echo __('new_location'); ?></label>
                                                                        <div class="controls form-horizontal">
                                                                     <?php  echo $this->Form->input('Location.name', array('label' => false, 'class' => 'input-xlarge focused') ); ?>
                                                                    <?php  echo $this->Form->input('Location.user_id', array('value' => $user_id, 'label' => false, 'type' => 'hidden')); ?>
