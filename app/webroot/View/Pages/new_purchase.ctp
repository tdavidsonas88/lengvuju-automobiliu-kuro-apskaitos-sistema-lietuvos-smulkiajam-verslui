						  ...
						  <fieldset>
                                                      ...
                                                      <div class="control-group form-horizontal">
                                                          ...
                                                          <div  class="controls form-horizontal">
                                                            <?php  echo $this->Form->input('Purchase.date', array('label' => false, 'class' => 'date') ); ?>
                                                          </div> 
                                                      </div>
                                                      ...
                                                      <div class="control-group form-horizontal">
                                                           ...
                                                           <div class="controls form-horizontal">
                                                               <?php
                                                                ...
                                                                ?>  
                                                                <?php  echo $this->Form->input('Purchase.users_id', array('value' => $users_id, 'label' => false, 'type' => 'hidden')); ?>
                                                            </div>
                                                      </div>
